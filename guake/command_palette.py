...
class CommandPalette(Gtk.Window):
    ...
    def _build_commands(self):
        ...
        cmds.extend([
            ...
            {"name": "Notifications", "category": "View",
             "action": lambda: self.guake.notification_center._toggle_popup() if hasattr(self.guake, 'notification_center') else None},
            {"name": "Clear Notifications", "category": "View",
             "action": lambda: self.guake.notification_center._clear_all() if hasattr(self.guake, 'notification_center') else None},
